...
public class App {
	...
	public static void main(String[] args) throws SQLException {
		...
		usuario.insert(new Usuario("Eowyn", 10.00, 8.00, 1));
		usuario.insert(new Usuario("Gandalf", 100.00, 5.00, 3));
		usuario.insert(new Usuario("Sam", 36.00, 8.00, 2));
		usuario.insert(new Usuario("Galadriel", 120.00, 5.00, 3));
		...
		System.out.println(usuario.delete(p));
		...
		atrcc.insert(new Atraccion("Moria", 10.00, 2.00, 6, 1));
		atrcc.insert(new Atraccion("Minas Tirith", 5.00, 2.50, 25, 3));
		atrcc.insert(new Atraccion("La Comarca", 3.00, 6.5, 150, 2));
		atrcc.insert(new Atraccion("Mordor", 25.00, 3.00, 4, 1));
		atrcc.insert(new Atraccion("Abismo de Helm", 5.00, 2.00, 15, 3));
		atrcc.insert(new Atraccion("Lothórien", 35.00, 1.00, 30, 2));
		atrcc.insert(new Atraccion("Erebor", 12.00, 3.00, 32, 3));
		atrcc.insert(new Atraccion("Bosque Negro", 3.00, 4.00, 12, 1));
		...
		nuevaPorcentual.insert(new PromocionPorcentual("pack Aventura", 8, 3, 0.0, 0.20, 0, 1));
		nuevaPorcentual.insert(new PromocionPorcentual("pack Aventura Mediterranea", 8, 3, 0.0, 0.5, 0, 1));
		...
		nuevaAxB.insert(new PromocionAxB("pack Paisaje", 2, 5, 7, 0.00, 0.00, 3));
		nuevaAxB.insert(new PromocionAxB("pack Aventura + 1 gratis", 1, 4, 8, 0.00, 0.00, 1));
		...
		nuevaAbs.insert(new PromocionAbsoluta("Pack Degustacion", 6, 3, 0.00, 36.00, 2));
		nuevaAbs.insert(new PromocionAbsoluta("pack Paisajes 2x1 ", 2, 5, 0.00, 40.00, 3));
