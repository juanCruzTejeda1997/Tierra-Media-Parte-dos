 ...
 * 
 * import DAO.AtraccionDAO; import DAO.AtraccionDAOImpl; import DAO.DAOFactory;
 * import DAO.ItinerarioDAOImpl; import DAO.PromocionAbsolutaDAO; import
 * DAO.PromocionAbsolutaDAOImpl; import DAO.PromocionAxBDAO; import
 * DAO.PromocionAxBDAOImpl; import DAO.PromocionPorcentualDAO; import
 * DAO.PromocionPorcentualDAOImpl; import DAO.UserDAO; import DAO.UserDAOImpl;
 * import model.Atraccion; import model.Itinerario; import
 * model.PromocionAbsoluta; import model.PromocionAxB; import
 * model.PromocionPorcentual; import model.Usuario;
 * 
 * public class App {
 * 
 ...
 * 
 * 
 * ItinerarioDAOImpl it = new ItinerarioDAOImpl(); Usuario n = new
 * Usuario("Eowyn", 10.00, 8.00, 1); usuario.insert(n);
 * 
 * 
 * LinkedList<Itinerario> itinerario =
 * it.buscarItinerarioPorUsuario(n.getNombre()); System.out.println(itinerario);
 * 
 ...
 * ); LinkedList<Atraccion> a = atrcc.getAtracciones();
 ...
 * System.out.println(nuevaPorcentual.getPromocionesPorcentuales(a));
 * 
 * 
