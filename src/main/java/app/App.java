	...
	public static void main(String[] args) throws SQLException {
		...
		/*  System.out.println("------------------------USUARIOS---------------------");
		 ...
		 Atraccion("Abismo de Helm", 5.00, 2.00, 15, 3)); atrcc.insert(new
		  ...
		  System.out.println("le resto un cupo a la atraccion " + atrcc.getAtracciones().get(1).getNombre());
		  System.out.println("su cupo inicial es de " + atrcc.getAtracciones().get(1).getCupo());
		  System.out.println("su id es " + atrcc.getAtracciones().get(1).getId());
		  
		  int idDeAtraccion;
		  idDeAtraccion = atrcc.getAtracciones().get(1).getId();
		 System.out.println(" le resto un cupo a la atracccion");
         atrcc.restarCupo(idDeAtraccion);
         System.out.println("el cupo de la atraccion ahora es" + atrcc.getAtracciones().get(1).getCupo());
...
//		System.out.println("------------------------PROMOCIONES---------------------");
	...
	//	System.out.println(atrcc.getAtracciones());
		...
		//System.out.println(atrcc.getAtracciones());
		//int id_promo = nuevaPorcentual.getPromocionesPorcentuales().get(1).getId();
...
*/
		 ...
		 ItinerarioDAOImpl itr = new ItinerarioDAOImpl();
		 
		 itr.insert(new Itinerario(4,2,3,2,1,2));
		 
		 
		 
		  
		 System.out.println(itr.getProductosAdquiridos());
