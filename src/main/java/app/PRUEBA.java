 ...
 * 
 * import DAO.AtraccionDAO; import DAO.DAOFactory;
 * 
 * import DAO.PromocionAbsolutaDAO; import DAO.PromocionAxBDAO; import
 * DAO.PromocionPorcentualDAO; import DAO.UserDAO; import model.Atraccion;
 * import model.PromocionAbsoluta; import model.PromocionAxB; import
 ...
 * ); AtraccionDAO atrcc = DAOFactory.getAtraccionDAO(); LinkedList<Atraccion> a
 * = atrcc.getAtracciones(); atrcc.insert(new Atraccion("Nueva", 10.00, 2.00, 6,
 * 1));
 * 
 * System.out.
 ...
 * 
 * System.out.println("OBJETO------------------------------");
 * System.out.println(nuevaAxB.getPromocionesAxB(a));
 * 
 * System.out.
 ...
 * System.out.println(nuevaAbs.getPromocionesAbsolutas(a));
 * 
 * System.out.
