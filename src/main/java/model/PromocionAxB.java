...
public int calcularCupo() {
	...
	public String toString() {
		if (this.tipo != null) {
			return "| NOMBRE = " + super.getNombre() + " | ATRACCION1 NOMBRE = "
					+ this.getAtraccion1().getNombre() + " | ATRACCION2 NOMBRE =  " + this.getAtraccion2().getNombre()
					+ " | ATRACCION GRATIS NOMBRE =  " + this.getAtraccion_gratis().getNombre() + " | TIPO = "
					+ super.getTipo() + " | COSTO = " + super.getCosto()+ " CUPO =" + super.getCupo();
		}
		return "| NOMBRE = " + super.getNombre() + " | ATRACCION1 ID = "
				+ super.getAtraccion1_id() + " | ATRACCION2 ID = " + super.getAtraccion2_id()
				+ " | ATRACCION_GRATIS ID =  " + this.getAtraccion_gratis_id() + " | TIPO =  " + super.getTipo_id()
